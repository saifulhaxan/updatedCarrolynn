...
export const BookDetailPage = () => {
  ...
  return (
    <LayoutTheme>
      ...
      <div className="BuyNowDetail carolyn_feedback_details">
        {/* <div className="buynowdetail_left"></div>
        <div className="buynowdetail_right"></div> */}
        <div class="feedback_top carolyn_feedback_heading">
          {bookDetail.reviews && <h1>Our Client Feedback</h1>}

          <div className="Feedbacks carolyn_feedback">
            {bookDetail.reviews &&
